...
function Navbar({ user, username }) { 
    ...
    return (
        <nav className="nav lg:rounded-xl relative text-white px-4 lg:w-3/4 lg:mx-auto py-3">
            <div className="flex items-center justify-between">
                ...
                <ul className="hidden md:flex gap-4 items-center">
                    ...
                    {!user ? (
                        <li><Link to="/register"><button className='register-login-btn h-12 w-auto rounded p-2 cursor-pointer'>Register/Login</button></Link></li>
                    ) : (
                        <>
